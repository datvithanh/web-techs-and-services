...
<body>
  ...
  ?>
    <form action="registrationform.php" method="post">
      ...
      Last Name <b>*</b>:<input type="text" name="l_name" value="<?php echo $l_name ?>" /> <br /> Email Address
      <b>*</b>:<input type="text" name="email" value="<?php echo $email ?>" /> <br /> Operating System: <input type="text" name="os" value="<?php echo $os ?>" /> <br /><br /> <input type="submit" name="submit" value="Submit" /> <input type="reset" />
    </form>
  <?php
  ...
  function check_form($f_name, $l_name, $email, $os)
  {
    if (!$l_name || !$email) {
      ...
      if (strpos($email, "@gmail.com") == false or strpos($email, "@yahoo.com")){
        echo "<h3>Sorry babe your email doesn't read right!</h3>";
        print_form($f_name, $l_name, $email, $os);
      }
      else
